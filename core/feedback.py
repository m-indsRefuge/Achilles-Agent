...
def log_event(event: RetrievalEvent, db: StorageManager):
    """Log retrieval tracking and update chunk stats with selective signals and confidence calibration."""
    ...
    # 2. Update retrieval_stats for each chunk (Calibrated Signal Reinforcement)
